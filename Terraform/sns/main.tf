...
resource "aws_sns_topic_bitwala_sivatest" "my_first_sns_topic" {
  name = var.sns_name
}

resource "aws_sns_topic_policy" "my_sns_topic_policy" {
  arn = aws_sns_topic_bitwala_sivatest.my_first_sns_topic.arn
...
data "aws_iam_policy_document" "my_custom_sns_policy_document" {
  ...
  statement {
    ...
    resources = [
      aws_sns_topic_bitwala_sivatest.my_first_sns_topic.arn,
    ]
